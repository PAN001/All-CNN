...
The two network architectures (`Strided-CNN,` and `All-CNN`) [4] together with the `Layer-sequential unit-variance (LSUV)` initialization [1] are implemented both in `Tensorflow` and `Keras`. 
